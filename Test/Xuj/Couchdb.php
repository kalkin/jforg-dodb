 ...
 * 
 */
class Test_Xuj_Couchdb extends Solar_Test {
     ...
     * 
     */
    protected $_Test_Xuj_Couchdb = array(
    );
    ...
    public function test__construct()
    {
        ...
        $actual = new Xuj_Couchdb($this->_config);
        $expect = 'Xuj_Couchdb';
    ...
    final public function test__call()
    {
        // we use `new` instead of Solar::factory() so that we get back the
        // factory class itself, not an adapter generated by the factory
        $obj = new Xuj_Couchdb($this->_config);
        try {
            $obj->noSuchMethod();
    ...
    {
        $actual = Solar::factory('Xuj_Couchdb');
        $expect = 'Xuj_Couchdb_Adapter';
        $this->assertInstance($actual, $expect);
    }
}
